...
from .views import (
    ...
    CashierOrderRefundView,
    CashierOrderRefundCompleteView,
    CustomerRefundDetailsView,
    CashierPaymentView,
    CashierReportsView,
    ReportsView,
...
urlpatterns = [
    ...
    path("<int:pk>/refund-details/", CustomerRefundDetailsView.as_view(), name="order-refund-details"),
    ...
    path("cashier/<int:pk>/refund/", CashierOrderRefundView.as_view(), name="cashier-order-refund"),
    path("cashier/<int:pk>/refund-complete/", CashierOrderRefundCompleteView.as_view(), name="cashier-order-refund-complete"),
